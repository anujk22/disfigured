    ...
    <section className="relative py-24 px-6 bg-gradient-to-b from-black via-gray-950 to-black">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-300 text-lg leading-relaxed mb-12">
          The site's structure is built around three layers of protection that work together rather than relying on a single safeguard.
        </p>
        ...
        {/* Visual Placeholder */}
        <div className="mt-12 rounded-2xl overflow-hidden bg-gradient-to-br from-purple-500/5 to-pink-500/5 border border-purple-500/20 p-12">
          <div className="flex items-center justify-center h-64">
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-400 italic">Moderation System Flowchart</p>
              <p className="text-gray-500 text-sm max-w-md mx-auto">Visual diagram showing the three-layer protection system</p>
            </div>
          </div>
        </div>
      </div>
